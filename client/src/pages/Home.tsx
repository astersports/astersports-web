  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-[#232d45]/90 backdrop-blur-xl border-b border-white/5"
          : "bg-transparent"
      }`}
    >
      <div className="container flex items-center justify-between h-16 md:h-20">
        ...
        <nav className="hidden sm:flex items-center gap-6">
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-[#F6CC55] to-[#E0631C] text-[#232d45] font-medium text-sm transition-transform duration-160 hover:scale-[1.03] active:scale-[0.97]"
            style={{ fontFamily: "var(--font-display)" }}
          >
      ...
      >
        <nav className="container pt-2 pb-6 flex flex-col gap-4 bg-[#232d45] border-b border-white/10 shadow-2xl">
          {NAV_PRODUCTS.map((p) => (
            <a
              key={p.id}
              href={p.href}
          ...
          <a
            href="#contact"
            className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-full bg-gradient-to-r from-[#F6CC55] to-[#E0631C] text-[#232d45] font-medium text-sm transition-transform duration-160 active:scale-[0.97]"
            style={{ fontFamily: "var(--font-display)" }}
            onClick={() => setMobileOpen(false)}
          >
            <Mail className="w-4 h-4" />
...
function HeroSection() {
  ...
  return (
    <section ref={sectionRef} onMouseMove={handleGlow} className="relative flex items-center overflow-hidden md:min-h-[100svh]">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-[#232d45] to-transparent" />
    </section>
  );
}
...
function PlatformSection() {
  ...
  return (
    <section id="platform" className="relative py-10 md:py-20 bg-[#232d45]">
...
function ServicesSection() {
  ...
  return (
    <section id="services" className="relative py-10 md:py-16 bg-[#2a3450]">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative">
              ...
              />
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-t from-[#2a3450] via-transparent to-transparent" />
            </div>
          </div>
        </div>
      </div>
...
function ProcessSection() {
  ...
  return (
    <section className="relative py-10 md:py-16 bg-[#232d45]">
      <div className="container" ref={ref}>
...
function AboutSection() {
  ...
  return (
    <section id="about" className="relative py-10 md:py-16 bg-[#2a3450]">
      <div className="container" ref={ref}>
...
function FAQSection() {
  ...
  return (
    <section id="faq" className="relative py-10 md:py-16 bg-[#232d45]">
      <div className="container" ref={ref}>
        <div className="max-w-3xl mx-auto">
...
function ContactSection() {
  ...
  return (
    <section id="contact" className="relative py-10 md:py-16 overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-[#232d45]/70" />
                ...
                <form onSubmit={handleSubmit} className="aster-panel p-6 md:p-8 space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg bg-[#252f49] border border-white/10 text-white placeholder-slate-500 focus:outline-none focus:border-[#F6CC55]/40 focus:ring-1 focus:ring-[#F6CC55]/20 transition-all"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-lg bg-[#252f49] border border-white/10 text-white placeholder-slate-500 focus:outline-none focus:border-[#F6CC55]/40 focus:ring-1 focus:ring-[#F6CC55]/20 transition-all resize-none"
                      placeholder="Tell us about your project..."
                    />
                  </div>
                  <button
                    type="submit"
                    className="w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-full bg-gradient-to-r from-[#F6CC55] to-[#E0631C] text-[#232d45] font-semibold text-base transition-transform duration-160 hover:scale-[1.02] active:scale-[0.97] shadow-lg shadow-[#F6CC55]/20"
                    style={{ fontFamily: "var(--font-display)" }}
                  >
...
function Footer() {
  return (
    <footer className="py-12 bg-[#1c2438] border-t border-white/5">
...
export default function Home() {
  return (
    <div className="relative min-h-screen bg-[#232d45] overflow-x-hidden">
