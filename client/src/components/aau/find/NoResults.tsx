  ...
  return (
    <div className="as-fade-in">
      <div className="mx-[22px] mt-[30px] text-center">
        ...
        <h4 className="m-0 font-[var(--font-display)] text-[16px] font-semibold" style={{ color: C.ink }}>
          No team or tournament yet
        </h4>
        <p className="mx-auto mt-[7px] max-w-[280px] text-[12.5px] leading-[1.55]" style={{ color: C.mut }}>
      ...
      <div className="px-[18px] pt-[18px]">
        <button
          type="button"
          onClick={onPaste}
          className="as-press flex min-h-[44px] w-full items-center justify-center gap-2 rounded-[13px] border-none p-[14px] font-[var(--font-display)] text-[14px] font-semibold"
      ...
      <div className="px-[18px] pt-[10px]">
        <button
          type="button"
          onClick={onRequest}
          className="as-press flex min-h-[44px] w-full items-center justify-center gap-2 rounded-[13px] p-[14px] font-[var(--font-display)] text-[14px] font-semibold"
