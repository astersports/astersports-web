...
function DropPill({ label, on, onClick }: { label: string; on: boolean; onClick: () => void }) {
  return (
    <button
      ...
      aria-expanded={on}
      onClick={onClick}
      className="as-press inline-flex min-h-[32px] items-center gap-[6px] rounded-full px-[11px] font-[var(--font-mono)] text-[12.1px]"
  ...
  return (
    <div className="as-fade-in">
      <div className="px-[18px] pt-[8px]">
        ...
        <h2 className="mt-1 font-[var(--font-display)] text-[19.8px] font-bold tracking-[-0.3px]" style={{ color: C.ink }}>
          Find a tournament
        </h2>
      </div>
      ...
      <div className="flex flex-wrap gap-[7px] px-[18px] pb-[4px] pt-[12px]">
          ...
          {([
            ...
            return (
              <button
                ...
                className="as-press min-h-[32px] px-[11px] font-[var(--font-mono)] text-[12.1px]"
        ...
        <button
          ...
          className="as-press min-h-[32px] rounded-full px-[12px] font-[var(--font-mono)] text-[12.1px]"
      ...
      <div className="px-[18px] pt-[8px] font-[var(--font-mono)] text-[11.5px]" style={{ color: C.mut }} aria-live="polite">
      ...
      {filtered.length === 0 ? (
        <div className="mx-[18px] mt-4 rounded-[15px] p-8 text-center" style={{ border: `1px solid ${C.hair}`, background: "linear-gradient(180deg,#F9FAFB,#FFFFFF)" }}>
          ...
          <button type="button" onClick={clearAll} className="as-press mt-2 text-[13.8px] underline" style={{ color: C.g3 }}>
            Clear filters
          </button>
        </div>
      ) : (
            ...
            return (
              <div key={cg.circuit} style={{ borderTop: `1px solid ${C.hair}` }}>
                ...
                >
                  ...
                  <span className="flex-1 font-[var(--font-display)] text-[15px] font-bold" style={{ color: C.ink }}>
                    {cg.circuit}
                  </span>
                  <span className="font-[var(--font-mono)] text-[11.5px]" style={{ color: C.mut }}>
                ...
                {isOpen &&
                  cg.seasons.map((s) => (
                    <div key={s.season}>
                      <div className="px-[18px] pb-[4px] pl-[32px] pt-[2px] font-[var(--font-mono)] text-[11.5px] uppercase tracking-[0.06em]" style={{ color: C.mut }}>
                        {s.season}
                      </div>
                      {s.tournaments.map((t) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span className="min-w-0 flex-1">
                              ...
                              <span className="mt-[2px] block truncate font-[var(--font-mono)] text-[11.5px]" style={{ color: C.mut }}>
