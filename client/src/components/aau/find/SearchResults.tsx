  ...
  return (
    ...
    >
      ...
      <span className="min-w-0 flex-1">
        <span className="flex items-center gap-[7px] font-[var(--font-display)] text-[14px] font-semibold" style={{ color: C.ink }}>
...
function DivisionRow({ d }: { d: AauDivisionHit }) {
  return (
    <div className="flex items-center gap-[12px] px-[18px] py-[11px]" style={{ borderTop: `1px solid ${C.hair}` }}>
      ...
      <span className="min-w-0 flex-1">
        <span className="block truncate font-[var(--font-display)] text-[14px] font-semibold" style={{ color: C.ink }}>
          {d.label ?? "Division"}
        </span>
        <span className="mt-[3px] block truncate font-[var(--font-mono)] text-[11px]" style={{ color: C.mut }}>
