    ...
    >
      ...
      >
        <div className="flex items-start justify-between">
          <span className="inline-flex items-center gap-[6px] font-[var(--font-mono)] text-[11.5px] uppercase tracking-[0.1em]" style={{ color: C.g3 }}>
        ...
        <div className="mt-[12px] text-center">
          <div id="plus-gate-title" className="font-[var(--font-display)] text-[26.9px] font-bold tracking-[-0.02em]">
            <span className="bg-[linear-gradient(95deg,#E8902A,#F6CC55,#FBD56B)] bg-clip-text text-transparent">$20</span>
            <span className="text-[17.3px]" style={{ color: C.dim }}>/mo</span>
          </div>
          <div className="font-[var(--font-mono)] text-[12.1px] uppercase tracking-[0.06em]" style={{ color: C.mut }}>Per account — not per kid, not per team</div>
          <div className="mt-[4px] font-[var(--font-display)] text-[14.6px] font-semibold" style={{ color: C.ink }}>One account. Every kid, every team.</div>
        </div>

        <div className="mt-[14px] space-y-[8px]">
          {FEATURES.map((f) => (
            <div key={f} className="flex items-start gap-[9px] text-[13.8px] leading-[1.4]" style={{ color: C.dim }}>
              <Check className="mt-[1px] h-[14px] w-[14px] shrink-0" style={{ color: C.pos }} /> {f}
            </div>
          ))}
          <div className="flex items-start gap-[9px] text-[13.8px] leading-[1.4]" style={{ color: C.mut }}>
        ...
        <button
          type="button"
          onClick={onClose}
          className="as-press mt-[16px] flex min-h-[46px] w-full items-center justify-center rounded-[12px] font-[var(--font-display)] text-[14.6px] font-bold"
          style={{ background: C.grad, color: "#1a1206" }}
        >
          Start Aster Plus
        </button>
        <div className="mt-[8px] text-center text-[11.5px]" style={{ color: C.mut }}>
          Annual $200 <span style={{ color: C.g3, fontWeight: 600 }}>(save $40)</span> · cancel anytime · Browse, Live &amp; public pages stay free.
        </div>
        <div className="mt-[6px] text-center font-[var(--font-mono)] text-[11.5px]" style={{ color: C.faint }}>
