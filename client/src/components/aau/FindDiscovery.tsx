    ...
    <div className="as-fade-in">
      ...
      {mode === "search" && term.length < 2 && (
        <div className="px-[18px] pt-[8px]">
          ...
          <div className="mt-[5px] text-[14.4px]" style={{ color: C.dim }}>
      ...
      {mode === "search" && (
        ...
        >
          ...
          <input
            ...
            className="w-full bg-transparent text-[14.6px] outline-none"
            style={{ color: C.ink }}
          />
          {term.length > 0 && (
            <button
      ...
      {mode !== "search" && (
        <button
          ...
          className="as-press mx-[18px] mt-[2px] inline-flex min-h-[44px] items-center gap-1 font-[var(--font-mono)] text-[12.6px]"
          style={{ color: C.mut }}
        >
          ‹ Back to search
        </button>
      ...
      {mode === "browse" &&
        (dir === null ? (
          dirError ? (
            <div className="mx-[18px] mt-4 rounded-[15px] p-6 text-center text-[13.8px]" style={{ border: `1px solid ${C.hair}`, background: "linear-gradient(180deg,#F9FAFB,#FFFFFF)", color: C.mut }}>
