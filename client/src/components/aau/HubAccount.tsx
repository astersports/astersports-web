  ...
  if (!user) {
    return (
      <button
        ...
        className="as-press inline-flex items-center gap-1.5 rounded-full border border-[#E2E8F0] bg-[#FFFFFF] px-3 py-[6px] text-[11px] font-semibold text-[#374151] disabled:opacity-60"
      >
