          ...
          <div className="px-[15px] py-[10px]">
            {day.games.map((g) => (
              <div key={g.teamKey + g.timeLabel} className="flex items-center gap-3 py-[7px]">
                <span className="font-[var(--font-mono)] text-[13.8px] font-semibold tabular-nums text-[#1A1D23] w-[58px] shrink-0">
                  {g.timeLabel}
                </span>
                <span className="min-w-0 flex-1">
                  <span className="block truncate text-[15px] font-semibold text-[#1A1D23]">{g.label}</span>
                  <small className="mt-0.5 block truncate font-[var(--font-mono)] text-[11.5px] text-[#4B5563]">
