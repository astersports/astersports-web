  ...
  return (
    <div className="overflow-hidden rounded-[16px] border border-[rgba(0,0,0,0.06)] border-t-[rgba(0,0,0,0.10)] bg-[linear-gradient(180deg,#F9FAFB,#FFFFFF)]">
      <div className="flex items-center justify-between px-4 pb-2.5 pt-3.5">
        <div>
          <div className="font-[var(--font-display)] text-[21.8px] font-semibold text-[#1A1D23]">{title}</div>
          {subtitle && <div className="mt-0.5 text-[17.6px] text-[#4B5563]">{subtitle}</div>}
        </div>
        {capLabel && (
          <span className="rounded-[7px] border border-[rgba(246,204,85,0.22)] bg-[rgba(246,204,85,0.08)] px-2 py-[3px] font-[var(--font-mono)] text-[16px] text-[#8F6708]">
            {capLabel}
          </span>
        )}
      </div>
      <table className="w-full border-collapse">
        <thead>
          <tr className="font-[var(--font-mono)] text-[14.4px] uppercase tracking-wide text-[#4B5563]">
        ...
        <tbody>
          ...
          {rows.length === 0 && (
            <tr>
              <td colSpan={4} className="px-3 py-6 text-center text-[19.2px] text-[#4B5563]">
      ...
      {footNote && (
        <div className={`flex items-center gap-1.5 border-t ${HAIR} px-3 py-2 font-[var(--font-mono)] text-[15.2px] text-[#4B5563]`}>
      ...
      {showAdvanceLine && (
        <tr>
          <td colSpan={4} className="p-0">
            <div className="flex items-center gap-2 bg-[rgba(94,203,143,0.07)] px-3 py-[6px] font-[var(--font-mono)] text-[14.4px] uppercase tracking-[0.07em] text-[#16A34A]">
