...
export default function TeamScores({ focusId, games, nameById }: Props) {
  ...
  return (
    <div className="rounded-[16px] border border-[#E2E8F0] bg-[#FFFFFF] p-4">
      <div className="mb-2 font-[var(--font-mono)] text-[11.5px] uppercase tracking-[0.14em] text-[#4B5563]">Their games</div>
          ...
          return (
            <div key={i} className="flex items-center justify-between gap-3 border-b border-[#EDF2F7] py-1.5 last:border-0">
              <span className="flex min-w-0 items-center gap-2">
                <span
                  className="shrink-0 rounded-[5px] px-[6px] py-[1px] font-[var(--font-mono)] text-[11.5px] font-bold"
                ...
                <span className="truncate text-[15px] text-[#374151]">
