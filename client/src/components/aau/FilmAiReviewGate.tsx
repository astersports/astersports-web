...
export default function FilmAiReviewGate() {
  return (
    <div className="mb-4 space-y-3">
      ...
      <div className="flex items-start gap-[11px] rounded-[14px] p-[13px]" style={{ border: `1px solid ${C.hair2}`, background: "linear-gradient(165deg,rgba(167,139,250,.08),rgba(18,26,46,.5))" }}>
      ...
      <div className="rounded-[14px] p-[13px]" style={{ border: "1px solid rgba(167,139,250,.28)", background: "linear-gradient(165deg,rgba(167,139,250,.08),rgba(18,26,46,.5))" }}>
