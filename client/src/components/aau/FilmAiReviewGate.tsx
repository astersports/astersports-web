  ...
  return (
    <div className="mb-4 space-y-3">
      ...
      <div className="flex items-start gap-[11px] rounded-[14px] p-[13px]" style={{ border: `1px solid ${C.hair2}`, background: "linear-gradient(165deg,rgba(167,139,250,.08),rgba(255,255,255,0.7))" }}>
        <div className="grid h-[34px] w-[34px] shrink-0 place-items-center rounded-full" style={{ border: "2px solid #7C3AED", color: "#7C3AED" }}>
        ...
        <div>
          ...
          <div className="mt-[3px] text-[11.5px] leading-[1.5]" style={{ color: C.dim }}>
            Highlights involve minors, so the full film room — per-kid reels, AI-tagged moments, and the play-by-play review — unlocks only for a <span style={{ color: "#7C3AED", fontWeight: 600 }}>verified guardian</span>, with consent and one-tap deletion built in.
          </div>
        </div>
      </div>
      ...
      <div className="rounded-[14px] p-[13px]" style={{ border: "1px solid rgba(167,139,250,.28)", background: "linear-gradient(165deg,rgba(167,139,250,.08),rgba(255,255,255,0.7))" }}>
        <span className="inline-flex items-center gap-[6px] rounded-[6px] px-[7px] py-[2px] font-[var(--font-mono)] text-[9px] font-bold tracking-[0.1em]" style={{ color: "#7C3AED", border: "1px solid rgba(167,139,250,.4)" }}>
          ◆ AI REVIEW · GROUNDED
        </span>
