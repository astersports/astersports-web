...
export default function HomeGatedSections({ teamCount }: { teamCount: number }) {
  ...
  return (
    <div className="mt-5 space-y-3 px-[18px]">
      ...
      <div className="overflow-hidden rounded-[16px] p-[14px]" style={{ border: "1px solid rgba(167,139,250,.24)", background: "linear-gradient(165deg,rgba(167,139,250,.10),rgba(18,26,46,.6))" }}>
        ...
        <div className="mt-[5px] text-[12px] leading-[1.55]" style={{ color: C.dim }}>
          When pool play wraps, you&apos;ll see exactly what each team needs — <span style={{ color: "#5ecb8f", fontWeight: 600 }}>clinched</span>, <span style={{ color: "#ff6b5e", fontWeight: 600 }}>out</span>, or the if/then (&ldquo;win 9:00 and you clinch the 4-seed&rdquo;). The conditions are exact math.
        </div>
        <div className="mt-[11px] flex items-center justify-between rounded-[11px] px-[11px] py-[9px]" style={{ background: "rgba(255,255,255,.03)", border: `1px solid ${C.hair}` }}>
