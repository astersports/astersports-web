...
function GatePill() {
  return (
    <span
      className="shrink-0 rounded-full px-[8px] py-[2px] font-[var(--font-mono)] text-[8.5px] font-semibold uppercase tracking-[0.08em]"
    ...
    <div className="mt-5 space-y-3 px-[18px]">
      ...
      <div className="overflow-hidden rounded-[16px] p-[14px]" style={{ border: "1px solid rgba(167,139,250,.24)", background: "linear-gradient(165deg,rgba(167,139,250,.10),rgba(255,255,255,0.7))" }}>
        ...
        <button
          ...
          className="as-press mt-[11px] flex min-h-[44px] w-full items-center justify-center gap-[6px] rounded-[10px] py-[9px] font-[var(--font-display)] text-[12px] font-bold"
