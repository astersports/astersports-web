...
function GatePill() {
  return (
    <span
      className="shrink-0 rounded-full px-[8px] py-[2px] font-[var(--font-mono)] text-[13.6px] font-semibold uppercase tracking-[0.08em]"
    ...
    <div className="mt-5 space-y-3 px-[18px]">
      ...
      <div className="flex items-start gap-[9px] rounded-[13px] px-[12px] py-[11px]" style={{ border: `1px solid ${C.hair2}`, background: "rgba(95,160,230,.05)" }}>
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center justify-between gap-2">
            <div className="font-[var(--font-display)] text-[20px] font-semibold" style={{ color: C.ink }}>Schedule-change watch</div>
            <GatePill />
          </div>
          <div className="mt-[2px] text-[18.4px] leading-[1.5]" style={{ color: C.mut }}>
      ...
      <div className="overflow-hidden rounded-[16px] p-[14px]" style={{ border: "1px solid rgba(167,139,250,.24)", background: "linear-gradient(165deg,rgba(167,139,250,.10),rgba(255,255,255,0.7))" }}>
        <div className="flex items-center justify-between">
          <span className="font-[var(--font-mono)] text-[16px] uppercase tracking-[0.12em]" style={{ color: "#7C3AED" }}>Saturday night · the bracket</span>
          <span className="flex items-center gap-[7px]">
            <GatePill />
            <Moon className="h-[14px] w-[14px]" style={{ color: "#7C3AED" }} aria-hidden />
          </span>
        </div>
        <div className="mt-[7px] font-[var(--font-display)] text-[21px] font-bold" style={{ color: C.ink }}>What it takes to make Sunday</div>
        <div className="mt-[5px] text-[19.2px] leading-[1.55]" style={{ color: C.dim }}>
        ...
        <div className="mt-[11px] flex items-center justify-between rounded-[11px] px-[11px] py-[9px]" style={{ background: "rgba(0,0,0,0.03)", border: `1px solid ${C.hair}` }}>
          <span className="font-[var(--font-mono)] text-[16.8px]" style={{ color: C.mut }}>Make the bracket</span>
          <span className="font-[var(--font-display)] text-[21.8px] font-bold" style={{ color: C.faint }}>—</span>
        </div>
        <div className="mt-[6px] text-[15.2px] italic leading-[1.5]" style={{ color: C.mut }}>
        ...
        <button
          ...
          className="as-press mt-[11px] flex min-h-[44px] w-full items-center justify-center gap-[6px] rounded-[10px] py-[9px] font-[var(--font-display)] text-[19.2px] font-bold"
