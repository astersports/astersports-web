...
/** Side-by-side / slider before-after comparison. */
export default function BeforeAfter({ beforeUrl, afterUrl, onDownload }: Props) {
  ...
  return (
    <div className="space-y-3">
      <div
        ref={ref}
        className="relative aspect-[3/4] w-full select-none overflow-hidden rounded-xl border bg-muted"
      ...
      >
        ...
        <div className="absolute inset-y-0 w-0.5 bg-white shadow-[0_0_0_1px_rgba(0,0,0,0.2)]" style={{ left: `${pos}%` }}>
