...
// Exercises the restored two-sided NNI band on redistributeVerdict (Copilot review on #99:
// the cap path was previously untested). Floor rejects clustering; cap rejects over-regularization.
describe("redistributeVerdict placementEvenness band (NNI cap)", () => {
