...
- **Spacing/radius.** Densest hexagonal packing of `M` points in area `A` gives `r_max = √(2A/(√3·M)) ≈ 1.075·√(A/M)`; scale by a relative radius `ε ∈ [0,1]` (Gamito & Maddock 2008). `ε ≈ 0.75` keeps it even-but-organic.
