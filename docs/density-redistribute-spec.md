...
> **Review status: DRAFT — committed verbatim for review, not ratified canon.**
> Authored by Claude (claude.ai, read-only review session) and committed here
> unchanged as the artifact under review. The architectural review (blockers +
> decisions for Frank/Architect) lives in the **PR review comments**, not in this
> file. The Architect/Frank ratify or amend D1–D4 before any wiring or flag flip.
